...
public class Experiment_SC_Bitflipping {
	...
	public static void main(String[] args) {
		...
		Channel<Integer> decoder = scat.createBFDecodeChannel(max_iter);
		...
		System.out.println("seriell concatenation of a (7,4,3) Hamming Code");
