...
import channels.SC_DecodeChannelNoECC;

public class Experiment_SC_NoECC {
	...
	public static void main(String[] args) {
		...
		Channel<Integer> encoder = scat.createEncodeChannel();
		Channel<Integer> decoder = new SC_DecodeChannelNoECC((HammingCode_4) code, (HammingCode_4) code);
